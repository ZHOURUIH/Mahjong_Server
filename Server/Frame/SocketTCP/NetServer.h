...
public:
	...
	void sendMessage(Packet* packet, IClient* player, bool destroyPacketEndSend = true);
	...
	template<typename T>
	static T* createPacket(T*& packet)
	{
		PACKET_TYPE type = mPacketFactoryManager->getPacketType<T>();
